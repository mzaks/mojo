...
def test_hash_simd_values():
    ...
    assert_equal(hash(SIMD[DType.int128, 1](1)), 6783673858180478921)
    assert_equal(hash(SIMD[DType.int64, 2](1, 0)), 5122900632109575720)
    assert_equal(hash(SIMD[DType.int256, 1](1)), 8329308917989271970)
    ...
    assert_equal(hash(SIMD[DType.int128, 1](-1)), 17522107111403053621)
    assert_equal(hash(SIMD[DType.int64, 2](-1)), 11199890586389833974)
    assert_equal(hash(SIMD[DType.int256, 1](-1)), 15177222231855370751)
